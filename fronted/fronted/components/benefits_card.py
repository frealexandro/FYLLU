...
def cta_card():
    return rx.box(
        rx.vstack(
            rx.heading("¡Desbloquea tu operación de analitycs ahora!", size="2xl", font_weight="bold", mb="4", color ="black"),
            rx.text("Descubre cómo RandIA puede integrarse perfectamente en tus procesos, potenciando tu creatividad y aliviando tu carga de trabajo.", mb="6", color="black"),
...
def benefit_card(title: str, description: str):
    return rx.card(
        rx.heading(title, size="lg", font_weight="semibold", mb="2", color="black"),
        rx.text(description, color="black"),
        width="100%",
        height="auto",
        p="4",
        bg="white",
...
def benefits():
    return rx.box(
        rx.vstack(
            rx.heading("BENEFICIOS DE USAR RANDIA", size="4xl", text_align="center", mb="8", color="black"),
            rx.grid(
